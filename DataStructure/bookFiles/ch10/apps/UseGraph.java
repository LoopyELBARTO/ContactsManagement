...
//    graph.addEdge(s6, s3, 1300);
    ...
    System.out.println();
      System.out.println();
      System.out.println("Shortest path starting at " + s1);
      shortestPaths(graph, s1);

      System.out.println();
      System.out.println();
      System.out.println("Shortest path starting at " + s0);
      shortestPaths(graph, s0);
